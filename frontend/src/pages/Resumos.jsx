      ...
      <div className="min-h-screen pb-32 pt-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <div className="bg-white dark:bg-slate-800/50 rounded-2xl p-5 border border-slate-100 dark:border-slate-700/50 animate-pulse">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 h-12 bg-slate-50 dark:bg-slate-700/30 rounded-xl" />
                <div className="w-full sm:w-64 h-12 bg-slate-50 dark:bg-slate-700/30 rounded-xl" />
              </div>
            </div>
          </div>
          <div className="grid grid-cols-1 ipad:grid-cols-2 ipad:lg:grid-cols-3 ipad:xl:grid-cols-4 gap-6 ipad:gap-8">
            {[1,2,3,4,5,6].map(i => (
              <div key={i} className="bg-white dark:bg-slate-800/50 rounded-[20px] border border-slate-200/60 dark:border-slate-700/50 shadow-sm h-[240px] flex flex-col overflow-hidden" style={{animationDelay:`${i*80}ms`}}>
                <div className="p-6 flex-1">
                  <div className="h-6 w-24 bg-violet-50 dark:bg-violet-900/20 rounded-full animate-pulse mb-4" />
                  <div className="h-5 w-3/4 bg-slate-100 dark:bg-slate-700/50 rounded-lg animate-pulse mb-4" />
                  <div className="space-y-2.5">
                    <div className="h-3.5 w-full bg-slate-50 dark:bg-slate-800/50 rounded animate-pulse" />
                    <div className="h-3.5 w-5/6 bg-slate-50 dark:bg-slate-800/50 rounded animate-pulse" />
                    <div className="h-3.5 w-2/3 bg-slate-50 dark:bg-slate-800/50 rounded animate-pulse" />
                  </div>
                </div>
                <div className="px-6 py-4 bg-slate-50/50 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-700/50"><div className="h-3.5 w-28 bg-slate-100 dark:bg-slate-700 rounded animate-pulse" /></div>
              </div>
            ))}
          </div>
        </div>
    ...
    <div className="min-h-screen pb-32 pt-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div className="mb-10" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-5 mb-6">
            <div className="flex-1">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white mb-2 flex items-center gap-3 tracking-tight">
                <div className="w-12 h-12 rounded-[14px] bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center shadow-lg shadow-violet-500/20">
            ...
            <Button 
              ...
              className="w-full sm:w-auto shadow-md bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 border-none"
            >
              Novo Resumo
            </Button>
          </div>
          ...
          {resumos.length > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              <div className="bg-white dark:bg-slate-800 rounded-[20px] p-5 border border-slate-200/80 dark:border-slate-700/80 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-[13px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Total de Resumos</span>
                  <div className="p-1.5 bg-violet-50 dark:bg-violet-900/30 rounded-lg">
                    <FileText size={16} className="text-violet-500" strokeWidth={2.5} />
                  </div>
                </div>
                <p className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">{statsResumos.total}</p>
                <p className="text-[12px] font-medium text-slate-400 mt-3">Documentos salvos</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-[20px] p-5 border border-slate-200/80 dark:border-slate-700/80 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-[13px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Matérias Cobertas</span>
                  <div className="p-1.5 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                    <Layers size={16} className="text-blue-500" strokeWidth={2.5} />
                  </div>
                </div>
                <p className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">{statsResumos.materiasCobertas}</p>
                <p className="text-[12px] font-medium text-slate-400 mt-3">Categorias diferentes</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-[20px] p-5 border border-slate-200/80 dark:border-slate-700/80 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-[13px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Esta Semana</span>
                  <div className="p-1.5 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg">
                    <BarChart2 size={16} className="text-emerald-500" strokeWidth={2.5} />
                  </div>
                </div>
                <p className="text-3xl font-extrabold text-emerald-600 dark:text-emerald-400 tracking-tight">+{statsResumos.novosNaSemana}</p>
                <p className="text-[12px] font-medium text-slate-400 mt-3">Novos conteúdos gerados</p>
              </div>
            </div>
          )}

          {/* Busca + Filtros Estilo Floating Island */}
          <motion.div 
          ...
          >
            ...
            <div className="w-full sm:w-56">
              <Select 
                ...
                className="h-12 rounded-[14px] border-none bg-slate-50 dark:bg-slate-900 text-[14px] font-bold"
              >
            ...
            <div className="flex items-center justify-center bg-slate-100 dark:bg-slate-700/50 h-12 px-4 rounded-[14px] border border-slate-200 dark:border-slate-700 text-[13px] font-bold text-slate-600 dark:text-slate-300 whitespace-nowrap">
        ...
        {resumosFiltrados.length === 0 ? (
          <motion.div className="flex flex-col items-center justify-center py-24 text-center" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
            {searchTerm || selectedMateria !== 'all' ? (
              <>
                <div className="w-24 h-24 bg-slate-100 dark:bg-slate-800/50 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-inner border border-slate-200 dark:border-slate-700">
              ...
              <>
                ...
                {/* Onboarding Steps Premium */}
                <div className="max-w-3xl mx-auto mb-10 grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
                  <motion.div
                    className="bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 rounded-[20px] p-6 shadow-sm"
                    initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
                  >
                    <div className="w-10 h-10 rounded-[12px] bg-violet-100 dark:bg-violet-900/40 flex items-center justify-center mb-4">
                      <span className="text-[16px] font-extrabold text-violet-600 dark:text-violet-400">1</span>
                    </div>
                    <p className="text-[15px] font-bold text-slate-900 dark:text-white mb-1.5 tracking-tight">Criar Documento</p>
                    <p className="text-[13px] font-medium text-slate-500 dark:text-slate-400 leading-snug">Abra o editor rico com um clique.</p>
                  </motion.div>
                  ...
                  >
                    <div className="w-10 h-10 rounded-[12px] bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center mb-4">
                      <span className="text-[16px] font-extrabold text-blue-600 dark:text-blue-400">2</span>
                    </div>
                    <p className="text-[15px] font-bold text-slate-900 dark:text-white mb-1.5 tracking-tight">Escrever e Formatar</p>
                    <p className="text-[13px] font-medium text-slate-500 dark:text-slate-400 leading-snug">Use templates, cores, listas e anexe fotos.</p>
                  </motion.div>
                  ...
                  >
                    <div className="w-10 h-10 rounded-[12px] bg-emerald-100 dark:bg-emerald-900/40 flex items-center justify-center mb-4">
                      <span className="text-[16px] font-extrabold text-emerald-600 dark:text-emerald-400">3</span>
                    </div>
                    <p className="text-[15px] font-bold text-slate-900 dark:text-white mb-1.5 tracking-tight">Vincular Matéria</p>
                    <p className="text-[13px] font-medium text-slate-500 dark:text-slate-400 leading-snug">Organize para encontrar sempre que precisar.</p>
                  </motion.div>
                </div>

                <Button variant="primary" size="lg" leftIcon={<Plus size={20} />} onClick={() => setShowModal(true)} className="shadow-lg shadow-indigo-500/25 bg-gradient-to-r from-indigo-600 to-violet-600 border-none">
          ...
          >
            {resumosFiltrados.map((resumo) => {
              ...
              return (
                ...
                >
                  <div
                    className="bg-white dark:bg-slate-800 rounded-[24px] shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-200/80 dark:border-slate-700/80 h-full flex flex-col relative cursor-pointer"
                    onClick={() => handleView(resumo)}
                  >
                    {/* Brilho superior baseado na matéria */}
                    <div 
                    ...
                    <div className="p-6 flex-1 flex flex-col relative z-10">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex gap-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-[12px] p-1 border border-slate-100 dark:border-slate-700 shadow-sm ml-1">
                          <button
                            ...
                            className="p-1.5 rounded-lg hover:bg-violet-50 dark:hover:bg-violet-900/50 text-slate-400 hover:text-violet-600 dark:text-slate-500 dark:hover:text-violet-400 transition-colors active:scale-95"
                            title="Editar"
                          >
                      ...
                      <h3 className="text-[17px] font-bold text-slate-900 dark:text-white mb-2 line-clamp-2 tracking-tight leading-snug">{resumo.titulo}</h3>
                      <p className="text-[14px] text-slate-500 dark:text-slate-400 line-clamp-3 leading-relaxed flex-1">{preview}</p>
                    </div>
                    ...
                    <div className="px-6 py-4 bg-slate-50/50 dark:bg-slate-800/30 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between">
                      ...
                      <span className="text-[12px] font-bold flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity -translate-x-2 group-hover:translate-x-0 duration-300" style={{ color: cor }}>
        ...
        {/* Modal de Criação/Edição e Visualização (Glassmorphism & Focus States) */}
        <AnimatePresence>
          {showModal && (
            <motion.div
              className="fixed inset-0 z-1000 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-900/60 backdrop-blur-md"
              initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              onClick={resetForm}
            >
              <motion.div
                className="bg-white dark:bg-slate-900 w-full sm:rounded-[24px] shadow-2xl border border-white/20 dark:border-slate-700/60 sm:max-w-5xl max-h-[96dvh] sm:max-h-[90vh] overflow-hidden flex flex-col print:max-h-full print:rounded-none"
              ...
              >
                ...
                <div className="flex items-center gap-4 px-6 py-4 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md print:hidden shrink-0 relative z-20">
                  <button
                    onClick={resetForm}
                    className="w-9 h-9 flex items-center justify-center rounded-full text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors shrink-0"
                  >
                  ...
                  <span className="font-bold text-slate-900 dark:text-white text-[16px] truncate flex-1 min-w-0 tracking-tight">
                  ...
                  <div className="flex items-center gap-2 shrink-0 ml-2">
                    {modalMode === 'edit' && (
                      <button
                        ...
                        className="px-5 py-2.5 rounded-xl text-[14px] font-bold bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-md shadow-violet-500/20 hover:from-indigo-700 hover:to-violet-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                      >
                      ...
                      <>
                        <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 rounded-xl p-1">
                          <button
                            ...
                            className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-500 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-700 disabled:opacity-30 transition-colors font-bold"
                          >
                          ...
                          <button
                            ...
                            className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-500 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-700 disabled:opacity-30 transition-colors"
                          >
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-[13px] font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 transition-colors disabled:opacity-50"
                        >
                ...
                {/* ── BODY MODAL ── */}
                {modalMode === 'edit' ? (
                  <form id="resumo-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto bg-slate-50/50 dark:bg-slate-950/50">
                    <div className="p-6 sm:p-8 space-y-6 max-w-4xl mx-auto">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                          <Input
                            ...
                            required
                            className="h-14 text-[16px] font-bold bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 focus:ring-4 focus:ring-violet-500/10"
                          />
                        </div>
                        <Select
                          ...
                          required
                          className="h-14 text-[15px] font-medium bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 focus:ring-4 focus:ring-violet-500/10"
                        >
                      ...
                      <div className="bg-white dark:bg-slate-900 rounded-[20px] border border-slate-200 dark:border-slate-700 shadow-sm p-2">
                        <div className="flex items-center justify-between mb-4 px-4 pt-3">
                          <div className="flex items-center gap-2">
                            ...
                            {formData.conteudo && (
                              <span className="flex items-center gap-1.5 text-[12px] font-medium text-slate-400 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 rounded-md">
                                <AlignLeft size={12} />
                          ...
                          {!editingId && (
                            <motion.button
                              ...
                              className="flex items-center gap-1.5 px-3 py-1.5 text-[12px] font-bold text-violet-700 dark:text-violet-400 bg-violet-50 dark:bg-violet-900/30 border border-violet-200 dark:border-violet-800 rounded-lg transition-colors"
                            >
                        ...
                        <div className="rounded-[16px] overflow-hidden focus-within:ring-4 focus-within:ring-violet-500/10 transition-shadow">
                      ...
                      <div className="bg-white dark:bg-slate-900 rounded-[20px] border border-slate-200 dark:border-slate-700 shadow-sm p-6">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center gap-2">
                            <label className="text-[15px] font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                              <Paperclip size={18} className="text-slate-400" />
                              Anexos Visuais
                            </label>
                            <span className="text-[12px] font-medium text-slate-400 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 rounded-md">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-[13px] font-bold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors disabled:opacity-40"
                          >
                        ...
                        {(formData.imagens?.length || 0) === 0 ? (
                          <div
                            onClick={() => imageInputRef.current?.click()}
                            className="w-full border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-[16px] p-8 flex flex-col items-center justify-center gap-3 text-slate-400 hover:border-violet-400 hover:text-violet-500 hover:bg-violet-50/50 dark:hover:bg-violet-900/10 transition-all cursor-pointer group"
                          >
                            ...
                            <span className="text-[15px] font-bold text-slate-600 dark:text-slate-300">Arraste fotos ou clique aqui</span>
                            <span className="text-[13px] font-medium">Fotos do caderno, slides ou atlas 3D</span>
                          </div>
                        ) : (
                  ...
                  <div className="flex-1 overflow-y-auto print:overflow-visible bg-white dark:bg-slate-950">
                    <div id="resumo-view-content" className="max-w-[720px] mx-auto px-6 sm:px-10 py-10 print:p-0">
                      ...
                      <div className="mb-10 pb-8 border-b border-slate-100 dark:border-slate-800">
                        <Badge color={getMateriaInfo((viewingResumo?.materiaId || formData.materiaId)).cor} size="md" className="mb-4">
                          {getMateriaInfo((viewingResumo?.materiaId || formData.materiaId)).nome}
                        </Badge>
                        <h1
                          className="font-extrabold text-slate-900 dark:text-white leading-tight mb-5 tracking-tight print:text-2xl"
                          style={{ fontSize: `${Math.min(viewFontSize * 2.2, 3)}em`, transition: 'font-size 0.2s' }}
                        >
                      ...
                      <div
                        className="prose prose-slate dark:prose-invert max-w-none
                          prose-headings:font-extrabold prose-headings:text-slate-900 dark:prose-headings:text-slate-100 prose-headings:tracking-tight
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800">
                            <h3 className="text-[15px] font-bold text-slate-800 dark:text-slate-200 mb-5 flex items-center gap-2">
                              <ImagePlus size={18} className="text-violet-500" /> Anexos e Referências
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                              {imgs.map((url, idx) => (
                                <a key={idx} href={url} target="_blank" rel="noopener noreferrer" className="block rounded-[20px] overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
