...
const SkeletonCard = ({ className = '' }) => (
  <div className={`bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl p-6 shadow-sm ${className}`}>
    <div className="animate-pulse">
      <div className="flex items-center justify-between mb-4">
        <div className="flex-1">
          <div className="h-4 bg-slate-200 rounded w-24 mb-2"></div>
          <div className="h-8 bg-primary-50 dark:bg-primary-950 rounded w-16"></div>
        </div>
        <div className="w-12 h-12 bg-primary-50 dark:bg-primary-950 rounded-xl"></div>
      </div>
    </div>
  </div>
);
...
const DashboardSkeleton = () => {
  return (
    <div className="min-h-screen pb-32 transition-colors duration-200">
      {/* Header Skeleton */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex-1 animate-pulse">
              <div className="h-8 bg-slate-100 dark:bg-slate-700 rounded-lg w-64 mb-2"></div>
              <div className="h-4 bg-slate-50 rounded w-48 mb-2"></div>
              <div className="h-4 bg-slate-50 rounded w-96"></div>
            </div>
            <div className="w-40 h-12 bg-slate-100 dark:bg-slate-700 rounded-xl animate-pulse"></div>
          </div>
        </div>
      </div>
